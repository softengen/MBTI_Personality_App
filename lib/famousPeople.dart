...
class _famousPeopleState extends State<famousPeoplePage> {
  ...
  Widget build(BuildContext context) {
    List<Widget> types = [
      Stack(children: [
        Container(
          ...
          child: Center(
            child: const Text(
              "MBTI Personality Types of Celebrities",
              style: TextStyle(
                  fontFamily: "Astro Space", color: Colors.white, fontSize: 30),
    ...
    body.forEach((key, value) {
      types.add(celebCard(text: key, page: value[0]));
    });
