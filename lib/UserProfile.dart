             ...
             Future<void> Save() async {
               if(oldPass.text == userData["pass"]){
                 if(nameController.text != ""){
                   userCollection.doc(user.uid).update({"name" : nameController.text});
                 }
                 if(newPass.text != ""){

                   if(newPass.text == newPass1.text) {
                     var cred = EmailAuthProvider.credential(email: userData["email"], password: oldPass.text);

                     await user.reauthenticateWithCredential(cred).then((value){
                       user.updatePassword(newPass.text).then((value) => {
                         userCollection.doc(user.uid).update({"pass": newPass.text})
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.all(Radius.circular(h*.02)),
                        ...
                        child: Padding(
                          ...
                          child: isEdit ? SizedBox() : Align(
                            ...
                            child: userData["result"] != null
                                ...
                                : Padding(
                                  padding: EdgeInsets.only(top: h*.65, left: w*.1, right: w*.1),
                                  child: Column(
                                    children: [
                                      const Text(
                                      ...
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: (){},
                                          style: ButtonStyle(
                                            backgroundColor: MaterialStateProperty.all(Colors.deepPurple.shade500)
                                          ),
                                          child: const Text(
                                              "Test Yourself",
                                            style: TextStyle(
